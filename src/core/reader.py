import os
from typing import Dict, List, Optional, Generator  # 确保导入 Optional
import yaml
...
class SmartPaper:
    ...
    def __init__(self, config_file: Optional[str] = None, output_format: str = "markdown"):  # 关键修改
        """初始化SmartPaper实例
    ...
    def process_paper(self, file_path: str, mode: str = "prompt", prompt_name: Optional[str] = None) -> Dict:  # 可选修改
        """处理单个论文文件
