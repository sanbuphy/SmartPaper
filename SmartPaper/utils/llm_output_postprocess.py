                    ...
                    try:
                        ...
                        if img_match:
                            ...
                            if base64_data:
                                ...
                                processed_text += f'<br><img src="data:{mime_type};base64,{base64_data}" alt="{alt_text}" style="max-width: 50%; display: block; margin-left: auto; margin-right: auto;"><br>'
                            else:
                                # 没有找到对应的图片数据，保留原引用
