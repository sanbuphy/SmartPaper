...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("---")  # 添加分隔线
        st.markdown("### 开源项目宣传")
        st.markdown("**项目名称**：[SmartPaper](https://github.com/sanbuphy/SmartPaper)")
        st.markdown("**项目描述**：一个迷你助手，帮助您快速阅读论文")
        st.markdown("**项目链接**：[点击访问](https://github.com/sanbuphy/SmartPaper)")
